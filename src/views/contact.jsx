...
const Contact = ({ language }) => {
  return (
    <section id="contacts" className="min-h-screen w-full py-20 bg-black relative">
      <div className="relative w-full max-w-[2000px] mx-auto px-6">
        <h2 className="text-4xl lg:text-5xl font-bold text-center mb-16 text-white tracking-tight">
          {language === "id" ? "Kontak" : "Contact"}
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Informasi Kontak */}
          <div className="bg-neutral-950 p-8 rounded-xl border border-white/10">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 text-neutral-400">
                ...
                <div>
                  ...
                  <a
                    href="mailto:rizkiyanaramdhani02@gmail.com"
              ...
              <div className="flex items-center space-x-4 text-neutral-400">
                <MapPin className="w-6 h-6 text-neutral-400 flex-shrink-0" />
                <div>
                  <p className="font-medium text-neutral-300">
          ...
          <div className="bg-neutral-950 p-8 rounded-xl border border-white/10">
            ...
            <div className="grid grid-cols-1 gap-6">
              <a
                ...
                className="flex items-center space-x-4 text-neutral-400 hover:text-white transition-colors duration-200"
              >
